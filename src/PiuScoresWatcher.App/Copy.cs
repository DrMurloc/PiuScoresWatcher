...
public static class Copy
{
    ...
    public static string NotRecordedBody(PostOutcome outcome) => outcome switch
    {
        ...
        PostOutcome.ChartUnknown => L("PIU Scores doesn't list this chart. Not recorded."),
    ...
    public static string ReviewReason(KeptBecause because) => because switch
    {
        ...
        KeptBecause.ChartUnknown => L("PIU Scores doesn't list this chart, so it wasn't recorded."),
